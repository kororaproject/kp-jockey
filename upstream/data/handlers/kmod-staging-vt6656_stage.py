...
class Staging_vt6656_stage_Driver(KernelModuleHandler):
    '''Handler for staging modules provided by kmod-staging package.
    '''
    def __init__(self, ui):
        KernelModuleHandler.__init__(self, ui, 'vt6656_stage',
                name=_('Staging kernel modules'),
                description=_('WARNING: Experimental drivers.'),
                rationale=_('Staging can provide this module: vt6656_stage\n\n'
