...
class Staging_STAGING_MODULE_Driver(KernelModuleHandler):
    '''Handler for staging modules provided by kmod-staging package.
    '''
    def __init__(self, ui):
        KernelModuleHandler.__init__(self, ui, 'STAGING_MODULE',
                name=_('Staging kernel modules'),
                description=_('WARNING: Experimental drivers.'),
                rationale=_('Staging can provide this module: STAGING_MODULE\n\n'
