...
class Staging_synaptics_i2c_rmi4_Driver(KernelModuleHandler):
    '''Handler for staging modules provided by kmod-staging package.
    '''
    def __init__(self, ui):
        KernelModuleHandler.__init__(self, ui, 'synaptics_i2c_rmi4',
                name=_('Staging kernel modules'),
                description=_('WARNING: Experimental drivers.'),
                rationale=_('Staging can provide this module: synaptics_i2c_rmi4\n\n'
