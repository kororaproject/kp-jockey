...
class Staging_r8192u_usb_Driver(KernelModuleHandler):
    '''Handler for staging modules provided by kmod-staging package.
    '''
    def __init__(self, ui):
        KernelModuleHandler.__init__(self, ui, 'r8192u_usb',
                name=_('Staging kernel modules'),
                description=_('WARNING: Experimental drivers.'),
                rationale=_('Staging can provide this module: r8192u_usb\n\n'
